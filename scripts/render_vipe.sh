...
AVAILABLE_GPUS="6,7"  # 사용하고 싶은 GPU ID들을 여기에 설정
...
run_experiment() {
    ...
    EGO_CAMERA_POSE_PATH="/home/nas4_user/taewoongkang/repos_4_students/dohyeon/Exo-to-Ego/Ego4d/DATA/annotations/ego_pose/train/camera_pose/${ego_uuid}.json"
    EXO_CAMERA_POSE_PATH="/home/nas4_user/taewoongkang/repos_4_students/dohyeon/Exo-to-Ego/Ego4d/DATA/takes/${take_name}/trajectory/gopro_calibs.csv"
    ONLINE_CALIBRATION_PATH="/home/nas4_user/taewoongkang/repos_4_students/dohyeon/Exo-to-Ego/Ego4d/DATA/takes/${take_name}/trajectory/online_calibration.jsonl"
