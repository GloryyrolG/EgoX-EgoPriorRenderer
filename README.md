...
- **If you want to reproduce the train/val dataset**, please refer to the [dataset info](https://github.com/kdh8156/EgoX-EgoPriorRenderer/blob/main/data_preprocess/dataset_info.csv), download data and metadata from [EgoExo4D](https://ego-exo4d-data.org/), and follow the preprocessing pipeline
